...
using LettersAdmin.Services;

namespace LettersAdmin.Controllers;
...
public class AuthController : Controller
{
    ...
    public AuthController(OneAccessTokenValidator tokenValidator, IConfiguration configuration, ILogger<AuthController> logger)
    {
        ...
        _tokenParameterName = configuration["OneAccess:TokenParameterName"] ?? "lettersAdminToken";
        _logger = logger;
    }
    ...
    public async Task<IActionResult> Callback()
    {
        ...
        _logger.LogInformation("User {User} authenticated via OneAccess for LettersAdmin", oneAccessToken.UserName);
    ...
    public async Task<IActionResult> Logout()
    {
        ...
        _logger.LogInformation("User logged out from LettersAdmin");
        return Redirect("/");
    }
}
